...
public class BootServiceNIO implements BootService {
	...
	@Inject
	public BootServiceNIO(LogService logService, ServerConfigParser serverConfigParser, DbConnector dbConnector, EngineFactory engineFactory) {
	...
	public void startServer(String[] args) {
		try {
			...
			engine = engineFactory.getEngineNIO(serverSocket, this, dbService);
			engine.run();
	...
	private ServerSocketChannel initServerSocket(int port) throws ServerSocketInitException {
		try {
